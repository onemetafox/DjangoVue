...
<script>
    ...
    import OffersTableBar from "../components/TableBars/OffersTableBar.vue";
        ...
        return {
           isLoading: true,
            ...
            products:[{
              id:'1',
              name:'10% off offer',
              proposition_details:"10% off",
              articles:["Skrivunderlägg Arlac", "svart	"],
            ...
            },
            {
              id:'2',
              name:'15% off offer',
              proposition_details:"15% off",
              articles:["Whiteboard prestige 90x60 cm vit"],
              data_range:"24/11/2021 - 24/12/2021",
